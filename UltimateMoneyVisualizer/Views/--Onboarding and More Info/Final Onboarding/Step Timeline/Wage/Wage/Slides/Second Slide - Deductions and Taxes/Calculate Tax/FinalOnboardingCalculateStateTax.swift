//
//  FinalOnboardingCalculateStateTax.swift
...
struct FinalOnboardingCalculateStateTax: View {
    @EnvironmentObject private var viewModel: FinalWageViewModel

    @State private var grossEarnings: Double = 12_343
    @State private var preTaxDeductions: Double = 321
    @State private var stateTaxesPaid: Double = 271
    ...
    var body: some View {
        GeometryReader { geo in
            VStack(spacing: 30) {
                FinalOnboardingTitleAndSubtitle(title: "Calculate State Tax", subtitle: "", geo: geo)
                ...
                VStack {
                    ...
                    Row(label: "State Taxes Paid", value: stateTaxesPaid.money()) {
            ...
            .sheet(isPresented: $taxesPaidTapped, content: {
                FinalOnboardingEnterAmount(amount: $stateTaxesPaid, format: .money) {
                    enterButton
                }
            })
        }
...
#Preview {
    FinalOnboardingCalculateStateTax()
