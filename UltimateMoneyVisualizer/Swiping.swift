...
struct Swiping: View {
    ...
    var body: some View {
        TabView(selection: $tab) {
            SwipingWageSection(tab: $tab).tag(0)
            SwipingExpenseSection(tab: $tab).tag(1)
            SwipingGoalSection(tab: $tab).tag(2)
            SwipingAllocationSection(tab: $tab).tag(3)
        }
...
// MARK: - SwipingAllocationSection

struct SwipingAllocationSection: View {
                    ...
                    VStack(spacing: 20) {
                        ...
                        VStack(spacing: 40) {
                            SwipingButton(label: "Let's Get Started!") {
                                user.getStatusTracker().hasSeenOnboardingFlow = true
...
struct SwipingExpenseSection: View {
    @Binding var tab: Int
...
struct SwipingGoalSection: View {
    // MARK: - Body
...
struct SwipingWageSection: View {
    // MARK: State
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showSheet, content: {
            SwipingEnterWageFirstTimeView(tab: $tab)
        })
    }
}
...
struct SwipingEnterWageFirstTimeView: View {
    @Binding var tab: Int
