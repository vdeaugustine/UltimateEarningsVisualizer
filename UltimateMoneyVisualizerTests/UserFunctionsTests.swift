...
final class UserFunctionsTests: XCTestCase {
    ...
    func testGetShiftsBetween() throws {
        ...
        let result1 = user.getShiftsBetween(startDate1, endDate1)
        ...
        let result2 = user.getShiftsBetween(startDate2, endDate2)
        ...
        let result3 = user.getShiftsBetween(startDate3, endDate3)
        ...
        let result4 = user.getShiftsBetween(startDate4, endDate4)
        ...
        let result5 = user.getShiftsBetween(startDate5, endDate5)
        ...
        let result6 = user.getShiftsBetween(startDate6, endDate6)
...
//        XCTAssertEqual(result7.count, 0, "Should return 0 shifts")
        ...
        let result8 = user.getShiftsBetween(startDate8, endDate8)
        ...
        let result9 = user.getShiftsBetween(startDate9, endDate9)
